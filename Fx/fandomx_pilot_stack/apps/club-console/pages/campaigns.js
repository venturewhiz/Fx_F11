...
export default function Campaigns() {
  ...
  return (
    <div>
      <h1 style={{ marginTop: 0 }}>Sponsor Value Dashboard</h1>
      <div style={{ marginBottom: 12 }}>
        Club Tenant ID: <input value={tenantId} onChange={(e) => setTenantId(e.target.value)} style={{ width: 240, padding: 6 }} />
      </div>
      ...
      <table border="1" cellPadding="8" style={{ borderCollapse: "collapse", width: "100%", borderColor: "#e4dbc6", background: "#fff" }}>
        ...
        <tbody>
          ...
          {!campaigns.length && <tr><td colSpan="7">No sponsor campaigns yet.</td></tr>}
        </tbody>
      </table>
    </div>
  );
